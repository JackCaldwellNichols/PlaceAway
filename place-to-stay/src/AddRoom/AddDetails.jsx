import { FormControl, FormControlLabel, InputAdornment, RadioGroup, Stack, TextField, Radio } from '@mui/material'
...
const {state: {details: {title, desc, price}},dispatch} = useValue()
...
const handlePriceChange = (e) => {
  ...
  return (
    ...
    "& .MuiTextField-root":{width: '100%', maxWidth: 500, m:1}
        ...
        />
                <InfoField 
                  mainProps={{name: 'desc', label: 'Description', value: desc }}
                  minLength={10}
