                ...
                <Card key={room._id}>
                  <ImageListItem sx={{height: '100% !important'}}>
                    <ImageListItemBar sx={{
                      ...
                      actionIcon={
                        <Tooltip title={room.username} sx={{mr: 5}}>
                            <Avatar src={room.userimage}/>
                        </Tooltip>
                      }
                      position='top'
                      />
                      <img src={room.images[0]} alt={room.title} style={{cursor: 'pointer'}} onClick={()=>dispatch({type: 'UPDATE_ROOM', payload: room})}/>
                      <ImageListItemBar 
                        title={room.title}
                        actionIcon={
                          <Rating 
                            sx={{color: 'rgba(255, 255, 255, 0.8)', mr: 5}}
                            defaultValue= {3.5}
                            precision={0.5}
