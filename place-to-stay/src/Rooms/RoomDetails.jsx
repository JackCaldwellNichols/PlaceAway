...
import { AppBar, Avatar, Container, Dialog, IconButton, Slide, Stack, Toolbar, Tooltip, Typography, Box, Rating } from '@mui/material'
...
const RoomDetails = () => {
    ...
    useEffect(()=>{
        if(room){ 
            const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${room.longitude},${room.latitude}.json?access_token=${process.env.REACT_APP_MAPBOX}`
            fetch(url)
        ...
        >
            ...
            >
                ...
                <Box  sx={{display: 'flex', alignItems: 'center'}}>
                    <Typography variant='h6' component='span'>{'Ratings: '}</Typography>
                    <Rating name='room-ratings' defaultValue={3.5} precision={0.5} emptyIcon={<StarBorder /> }/>
                </Box>
